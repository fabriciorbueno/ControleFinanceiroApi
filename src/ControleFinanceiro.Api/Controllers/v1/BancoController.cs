...
namespace ControleFinanceiro.Api.Controllers.v1
{
    ...
    public class BancoController : Controller
    {
        ...
        public BancoController(IGenericService service)
        {
            _service = service;
        }
        ...
        {
            var response = await _service.BuscarTodosAsync(TabelaEnum.Banco);
        ...
        {
            var response = await _service.InserirAsync(TabelaEnum.Banco, categoriaRequest);

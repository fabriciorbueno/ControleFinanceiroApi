...
namespace ControleFinanceiro.Api.Controllers.v1
{
    ...
    public class SubCategoriaController : Controller
    {
        ...
        public SubCategoriaController(IGenericService service)
        {
            _service = service;
        }
        ...
        {
            var response = await _service.BuscarTodosAsync(TabelaEnum.SubCategoria);
        ...
        {
            var response = await _service.InserirAsync(TabelaEnum.SubCategoria, categoriaRequest);

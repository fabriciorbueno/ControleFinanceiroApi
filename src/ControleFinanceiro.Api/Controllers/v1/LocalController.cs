...
namespace ControleFinanceiro.Api.Controllers.v1
{
    ...
    public class LocalController : Controller
    {
        ...
        public LocalController(IGenericService service)
        {
            _service = service;
        }
        ...
        {
            var response = await _service.BuscarTodosAsync(TabelaEnum.Local);
        ...
        {
            var response = await _service.InserirAsync(TabelaEnum.Local, categoriaRequest);

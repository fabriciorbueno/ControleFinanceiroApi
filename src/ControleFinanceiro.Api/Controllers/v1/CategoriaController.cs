...
namespace ControleFinanceiro.Api.Controllers.v1
{
    ...
    public class CategoriaController : Controller
    {
        ...
        public CategoriaController(IGenericService service)
        {
            _service = service;
        }
        ...
        {
            var response = await _service.BuscarTodosAsync(TabelaEnum.Categoria);
        ...
        {
            var response = await _service.InserirAsync(TabelaEnum.Categoria, categoriaRequest);

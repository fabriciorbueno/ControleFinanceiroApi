...
namespace ControleFinanceiro.Api.Controllers.v1
{
    ...
    public class PrioridadeController : Controller
    {
        ...
        public PrioridadeController(IGenericService service)
        {
            _service = service;
        }
        ...
        {
            var response = await _service.BuscarTodosAsync(TabelaEnum.Prioridade);
        ...
        {
            var response = await _service.InserirAsync(TabelaEnum.Prioridade, categoriaRequest);

...
{
    public class PrioridadeRepository : IGenericRepository
    {
        ...
        public async Task<bool> InserirAsync(RequestBase categoriaRequest)
        {
            try
            {
                ...
                query = string.IsNullOrEmpty(categoriaRequest.Descricao)
                    ? @"INSERT INTO PRIORIDADE (NOME)VALUES (@NOME)"
                    : @"INSERT INTO PRIORIDADE (NOME, DESCRICAO) VALUES (@NOME, @DESCRICAO)";

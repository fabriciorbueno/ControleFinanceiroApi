...
{
    public class DestinatarioRepository : IGenericRepository
    {
        ...
        public async Task<bool> InserirAsync(RequestBase categoriaRequest)
        {
            try
            {
                ...
                query = string.IsNullOrEmpty(categoriaRequest.Descricao)
                    ? @"INSERT INTO DESTINATARIO (NOME)VALUES (@NOME)"
                    : @"INSERT INTO DESTINATARIO (NOME, DESCRICAO) VALUES (@NOME, @DESCRICAO)";
